...
const batch = ['batch2', 'batch3', 'batch4', 'batch5'].includes(process.argv[2]) ? process.argv[2] : 'batch2';
const configs = {
...
if (['batch3','batch4','batch5'].includes(batch)) for (const word of [
...
if (batch === 'batch4' || batch === 'batch5') for (const word of [
...
if (batch === 'batch5') for (const word of [
