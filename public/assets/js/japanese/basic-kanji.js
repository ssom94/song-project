(() => {
	...
	RADICALS.push(...[
		...
		["牙","牙","어금니 아","きばへん","왼쪽","이·맞물림","牙|雅|邪","象牙|優雅|邪魔"],["瓜","瓜","오이 과","うり","아래·둘러싸기","열매·박과 식물","瓜|孤|弧","西瓜|孤立|括弧"],["瓦","瓦","기와 와","かわら","오른쪽·아래","기와·도기","瓦|瓶|甕","瓦解|花瓶"],["甘","甘","달 감","あまい","아래·둘러싸기","단맛·만족","甘|甚|某","甘味|甚大|某所"],["生","生","날 생","うまれる・せい","아래·왼쪽","생명·발생","生|産|甥|性","生活|生産|出生"],["用","用","쓸 용","もちいる","둘러싸기","사용·기능","用|甫|備","利用|応用|準備"],["疋","疋|⺪","짝 필","ひき・ひきへん","왼쪽·아래","발·짝·바름","疑|疎|楚|蛋","疑問|疎外|清楚"],["癶","癶","등질 발","はつがしら","위","벌린 두 발·출발","発|登|癸","発展|登場"],["皮","皮","가죽 피","けがわ・ひのかわ","왼쪽·오른쪽","가죽·표면","皮|波|被|破","皮膚|波及|被害"],["矛","矛","창 모","ほこ・ほこへん","왼쪽","창·찌르기","矛|柔|務|霧","矛盾|柔軟|勤務"],
		["矢","矢","화살 시","や・やへん","왼쪽","화살·곧음","矢|知|短|矯","矢印|知識|短縮"],["禸","禸","짐승발자국 유","ぐうのあし","아래·둘러싸기","자취·영역","禺|離|禽|偶","離脱|家禽|偶然"],["舌","舌","혀 설","した・したへん","왼쪽·아래","혀·말·맛","舌|話|活|辞","舌戦|会話|活用"],["舛","舛","어그러질 천","まいあし","아래","엇갈린 두 발","舞|舜|隣","舞台|近隣"],["舟","舟","배 주","ふね・ふねへん","왼쪽","배·운반","船|航|般|艦","船舶|航空|一般"],["艮","艮","괘이름 간","こん・こんづくり","오른쪽·아래","뒤돌아봄·멈춤","根|限|眼|退","根拠|限界|眼科"],["色","色","빛 색","いろ","아래·오른쪽","색·모습","色|絶|艶","特色|絶対|艶麗"],["虍","虍","범호엄 호","とらかんむり・とらがしら","위·왼쪽","호랑이·위엄","虎|虐|虚|慮","虎視|虐待|虚偽"],["血","血","피 혈","ち","아래·왼쪽","피·혈액","血|衆|恤","血液|大衆"],["行","行","다닐 행","ぎょうがまえ・ゆきがまえ","둘러싸기","길·이동","行|術|街|衛","行動|技術|街頭"],
		["襾","西|覀","덮을 아","にし・おおいかんむり","위","덮음·서쪽","西|要|票|覆","西洋|重要|投票"],["見","見","볼 견","みる","오른쪽·아래","보기·관찰","見|規|視|親","意見|規則|視察"],["角","角","뿔 각","つの・つのへん","왼쪽·위","뿔·모서리","角|解|触|競","角度|解決|接触"],["谷","谷","골 곡","たに・たにへん","왼쪽·아래","골짜기·빈 공간","谷|欲|容|俗","渓谷|欲望|内容"],["豆","豆","콩 두","まめ・まめへん","아래·왼쪽","콩·제기","豆|豊|頭|登","大豆|豊富|頭脳"],["豕","豕","돼지 시","いのこ・いのこへん","왼쪽·아래","돼지·가축","豚|家|象|豪","養豚|家屋|豪華"],["豸","豸","해태 치","むじなへん","왼쪽","짐승·동물","豹|貌|貂","全貌|風貌"],["赤","赤","붉을 적","あか・あかへん","왼쪽·아래","붉음·불","赤|赦|赫","赤字|赦免|赫々"],["走","走","달릴 주","そうにょう・はしる","왼쪽 아래","달리기·이동","走|起|超|越","走行|起業|超過"],["身","身","몸 신","み・みへん","왼쪽","몸·신분","身|射|躬|軀","身体|放射|身分"],
		["辛","辛","매울 신","からい・しん","왼쪽·위","매움·형벌","辛|辞|辟|辣","辛苦|辞職|辛辣"],["辰","辰","별 진","しんのたつ","왼쪽·아래","때·진동","辰|振|震|農","振動|地震|農業"],["里","里","마을 리","さと・さとへん","왼쪽·아래","마을·거리","里|野|量|重","郷里|分野|数量"],["長","長","길 장","ながい・ながへん","왼쪽·위","길이·어른","長|張|帳|髪","長期|主張|帳簿"],["隶","隶","미칠 이","れいづくり","오른쪽·아래","붙잡음·따름","隷|逮|康","隷属|逮捕|健康"],["革","革","가죽 혁","かわへん・つくりがわ","왼쪽·아래","가죽·변화","革|靴|鞄|鞭","改革|革新|靴下"],["韋","韋","가죽 위","なめしがわ","왼쪽·오른쪽","가죽·에워쌈","違|衛|韓|韻","違反|衛生|韓国"],["音","音","소리 음","おと・おとへん","왼쪽·아래","소리·음악","音|意|韻|響","音響|意味|韻律"],["風","風","바람 풍","かぜ・かぜがまえ","둘러싸기","바람·풍습","風|嵐|颯","風景|台風|風習"],["飛","飛","날 비","とぶ","둘러싸기","날기·빠름","飛|翻|飜","飛躍|翻訳"],
		["首","首","머리 수","くび","아래·위","머리·우두머리","首|道|導|馘","首都|指導|首脳"],["香","香","향기 향","かおり・こう","왼쪽·아래","향기·냄새","香|馨|馥","香水|芳香"],["骨","骨","뼈 골","ほね・ほねへん","왼쪽·아래","뼈·골격","骨|骸|滑","骨格|遺骸|滑稽"],["高","高","높을 고","たかい","위·아래","높음·큰 건물","高|稿|縞|敲","高度|原稿|高尚"],["髟","髟","터럭발 표","かみがしら・かみかんむり","위","긴 머리털","髪|髭|髷","頭髪|髭面"],["鬼","鬼","귀신 귀","おに・きにょう","아래·오른쪽","귀신·혼","鬼|魂|魅|魔","鬼才|魂胆|魅力"],["鹿","鹿","사슴 록","しか・しかへん","왼쪽·위","사슴·짐승","鹿|麓|麗","鹿角|山麓|華麗"],["麥","麦","보리 맥","むぎ・ばくにょう","아래·왼쪽","보리·곡식","麦|麺|麹","小麦|麺類"],["麻","麻","삼 마","あさ・あさかんむり","왼쪽 위","삼·섬유","麻|摩|磨|魔","麻酔|摩擦|研磨"],["黃","黄","누를 황","き・きいろ","아래·둘러싸기","노란색·빛","黄|横|廣","黄金|横断|黄色"],
		["黑","黒","검을 흑","くろ・くろへん","왼쪽·아래","검음·그을음","黒|墨|黙|点","黒字|墨守|沈黙"],["鼠","鼠","쥐 서","ねずみ・ねずみへん","왼쪽·아래","쥐·작은 동물","鼠|鼬|竄","鼠害|逃竄"],["鼻","鼻","코 비","はな・はなへん","왼쪽·아래","코·후각","鼻|鼾|嚏","鼻炎|鼻音"],["齒","歯","이 치","は・はへん","왼쪽·아래","이·나이","歯|齢|齟|齬","歯科|年齢|齟齬"],["龍","竜","용 룡","りゅう・たつ","왼쪽·아래","용·힘","竜|襲|籠|滝","恐竜|襲撃|籠城"]
	]);
	...
	Object.assign(RADICAL_ORIGINS, {
		牙:'위아래 어금니가 맞물린 모습', 瓜:'덩굴에 열린 박과 열매', 瓦:'서로 맞물리는 기와 조각', 甘:'입 안에 맛있는 것이 든 모습', 生:'땅에서 새싹이 돋아나는 모습', 用:'울타리나 통을 짠 모습(자원에는 여러 설이 있음)', 疋:'발과 다리를 본뜬 모습', 癶:'두 발이 좌우로 벌어진 모습', 皮:'손으로 짐승 가죽을 벗기는 모습', 矛:'긴 자루 끝에 날이 달린 창',
		矢:'촉과 깃이 달린 화살', 禸:'짐승의 발자국이나 영역을 나타낸 모습', 舌:'입 밖으로 나온 혀', 舛:'서로 반대 방향을 향한 두 발', 舟:'물 위에 뜬 배의 옆모습', 艮:'사람이 뒤를 돌아보는 모습', 色:'사람이 서로 마주한 모습에서 얼굴빛을 나타냄(자원에는 여러 설이 있음)', 虍:'호랑이 머리와 무늬', 血:'그릇에 담긴 피', 行:'네거리와 길이 교차한 모습',
		襾:'물건 위를 덮은 덮개', 見:'눈을 크게 뜨고 바라보는 사람', 角:'짐승 머리에 난 뿔', 谷:'산 사이로 물이 흐르는 골짜기', 豆:'굽이 높은 제사용 그릇', 豕:'주둥이와 배·다리가 있는 돼지', 豸:'몸을 길게 뻗은 짐승', 赤:'불 위에서 붉게 달아오른 모습', 走:'팔을 흔들며 달리는 사람과 발', 身:'배가 불룩한 사람의 몸',
		辛:'날이 선 형벌 도구', 辰:'조개껍데기로 만든 농기구 또는 때를 나타낸 글자(자원에는 여러 설이 있음)', 里:'밭과 사람이 사는 터전이 합쳐진 마을', 長:'긴 머리카락을 늘어뜨린 노인', 隶:'손으로 꼬리를 붙잡은 모습', 革:'털을 벗겨 펼친 가죽', 韋:'성이나 경계를 빙 둘러 걷는 발', 音:'말씀 言에 소리의 표시를 더한 모습', 風:'바람 속에서 움직이는 벌레를 그린 옛 글자', 飛:'새가 두 날개를 펴고 나는 모습',
		首:'머리카락과 눈이 있는 머리', 香:'곡식에서 향기가 피어오르는 모습', 骨:'뼈마디와 살을 나타낸 모습', 高:'높은 누각이나 성문', 髟:'긴 머리카락이 늘어진 모습', 鬼:'큰 머리를 쓴 사람 모양의 귀신', 鹿:'뿔과 네 다리가 있는 사슴', 麥:'이삭이 달린 보리와 걸어오는 발', 麻:'집 안에서 삼 줄기를 말리는 모습', 黃:'빛나는 노란 패옥 또는 불빛(자원에는 여러 설이 있음)',
		黑:'불에 그을려 검어진 모습', 鼠:'앞니와 긴 꼬리가 있는 쥐', 鼻:'코를 뜻하게 된 自와 소리 요소가 합쳐진 글자', 齒:'입 안에 줄지어 난 이', 龍:'뿔·긴 몸·꼬리가 있는 용'
	});
