(() => {
	...
	async function previewCalendarDate(date,anchor) {
		...
		catch { const card=calendarPreviewCard(); card.replaceChildren(); card.hidden=false; card.appendChild(Object.assign(document.createElement('p'),{textContent:t('미리보기를 불러오지 못했습니다.','プレビューを読み込めませんでした。')})); }
	}
